/*
 modified 05 Sep 2025
 by Mason Lee (mason@wiznet.io)
 ...
 */
#ifndef w55rp20_ethernet3_h
#define w55rp20_ethernet3_h
...
public:
  ...
  EthernetClass() { _dhcp = NULL; _pinCS = 20; _maxSockNum = 8; }

  void setRstPin(uint8_t pinRST = 25);
  void setCsPin(uint8_t pinCS = 20);
